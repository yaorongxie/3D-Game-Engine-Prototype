...
public:
    ...
    static inline bool IsCloseEnough(Vector2 a, Vector2 b)
    {
        return Math::IsCloseEnuf(a.x, b.x) && Math::IsCloseEnuf(a.y, b.y);
    }
};
...
#pragma warning(pop)
    ...
    static inline bool IsCloseEnough(Vector3 a, Vector3 b)
    {
...
#pragma warning(pop)
    ...
    static inline bool IsCloseEnough(Vector4 a, Vector4 b)
    {
        return Math::IsCloseEnuf(a.x, b.x) && Math::IsCloseEnuf(a.y, b.y) && 
            Math::IsCloseEnuf(a.z, b.z) && Math::IsCloseEnuf(a.w, b.w);
    }
};
